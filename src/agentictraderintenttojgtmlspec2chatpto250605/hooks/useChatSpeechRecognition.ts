...
const useChatSpeechRecognition = (): SpeechRecognitionHook => {
  ...
  useEffect(() => {
    ...
    // This check is important for TypeScript to know SpeechRecognitionAPI is not undefined
    ...
    newRecognition.onresult = (event: SpeechRecognitionEvent) => {
      ...
      // When interimResults is true, the last item in event.results might be interim.
      // We want to build the full string from all parts, then the last interim part.
...
export default useChatSpeechRecognition;
